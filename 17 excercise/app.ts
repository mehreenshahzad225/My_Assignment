...
//excercise 16 print array
 ...
 let guest : string [] = ["Anum","Kehkasha","Manal","Anumta","Muskan"]
 console.log("Due to  space only two peopele invite for dinner ")

 //Remove people (invite two people)

while(guest.length > 2){
    const removeGuest = guest.pop()   //remove last guest
    console.log(`Sorry ${removeGuest},you are not invited Dinner`)
}
guest.forEach((guest) => console.log(`Dear ${guest},you still invited`))
